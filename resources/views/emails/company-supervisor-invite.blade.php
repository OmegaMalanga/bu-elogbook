...
<body style="font-family: Arial, sans-serif; background-color: #f8fafc; padding: 24px; margin: 0;">
    <div style="max-width: 560px; margin: 0 auto; background: #ffffff; border-radius: 8px; overflow: hidden;">
        ...
        <div style="padding: 24px; color: #1e293b;">
            ...
            <p>
                <strong>{{ $student->name }}</strong> has named you as their
                <strong>company supervisor</strong> for their internship at
                <strong>{{ $internship->company_name }}</strong> on the BU E-Logbook system.
            </p>

            <p>
                Click below to create your account. You'll be able to review
                {{ $student->name }}'s daily internship reports and, once all
                reports are reviewed, complete their evaluation.
            </p>

            <p style="margin-top: 24px;">
                <a href="{{ route('company-supervisor.invite.accept', ['token' => $token]) }}"
