...
<body style="font-family: Arial, sans-serif; background-color: #f8fafc; padding: 24px; margin: 0;">
    <div style="max-width: 560px; margin: 0 auto; background: #ffffff; border-radius: 8px; overflow: hidden;">
        ...
        <div style="padding: 24px; color: #1e293b;">
            ...
            <p>
                You have been assigned as the <strong>university supervisor</strong> for
            ...
            <p>
                ...
                reports are reviewed, assign their final grade.
            </p>

            <p style="margin-top: 24px;">
                <a href="{{ route('login') }}"
                   style="background: linear-gradient(to right, #FF9F1C, #FF7A1C); color: #ffffff; text-decoration: none; padding: 10px 20px; border-radius: 6px; font-weight: 600; display: inline-block;">
                    Log In
                </a>
            </p>
