    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('log-entries.update', $logEntry) }}">
                     @csrf @method('PATCH')

                    <div class="mb-4">
                        <label class="block font-medium text-sm text-gray-700 mb-1">Report Date *</label>
                        <input type="date" name="date" value="{{ old('date', \Carbon\Carbon::parse($logEntry->date)->format('Y-m-d')) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="operations_carried_out" rows="4" maxlength="1000"
                                  ...
                                  required>{{ old('operations_carried_out', $logEntry->operations_carried_out) }}</textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="tools_equipment_used" rows="2" maxlength="500"
                                  ...
                                  required>{{ old('tools_equipment_used', $logEntry->tools_equipment_used) }}
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="challenges_faced" rows="3" maxlength="500"
                                  class="border-gray-300 rounded w-full"
                                  placeholder="Any challenges or obstacles you faced? (optional)">{{ old('challenges_faced', $logEntry->challenges_faced) }}</textarea>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="recommendations" rows="3" maxlength="500"
                                  class="border-gray-300 rounded w-full"
                                  placeholder="Suggestions for improvement or future actions (optional)">{{ old('recommendations', $logEntry->recommendations) }}</textarea>
                    </div>
